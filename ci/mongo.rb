...
namespace :ci do
  namespace :mongo do
    ...
    task :install => ['ci:common:install'] do
      sh %Q{[ -e $HOME/downloads/mongodb-linux-x86_64-2.6.6.tgz ] || wget -k -O $HOME/downloads/mongodb-linux-x86_64-2.6.6.tgz https://fastdl.mongodb.org/linux/mongodb-linux-x86_64-2.6.6.tgz}
